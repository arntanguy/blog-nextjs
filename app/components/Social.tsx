...
export default function SocialButtons({ social = DefaultSocials }: { social?: SocialType[] }) {
  return (
    <>
    ...
    { 
      social.map((s : any) => {
       return (
        <a href={s.url} key={s.url} className="mx-2 lg:mx-4 dark:bg-gray-700 dark:hover:bg-gray-600 p-3 lg:p-4 rounded-lg" target="_blank" rel="noopener noreferrer">
              {s.icon}
        </a>)
      })
    }
