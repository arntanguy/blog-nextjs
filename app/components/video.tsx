...
export default function Video ({ url, fullWidth = true, border = false } : { url: string, fullWidth?: boolean, border?: boolean }) {
  return (
    ...
    <div className={ clsx(
    border && 'bg-gray-300 dark:bg-gray-700 rounded-xl overflow-hidden shadow-lg h-full w-full py-2 sm:py-4 lg:py-8 mt-6 sm:mt-8 lg:mt-12 mb-6 sm:mb-8 lg:mb-12') }>
